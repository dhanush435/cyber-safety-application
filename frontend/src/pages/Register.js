    ...
    <div className="min-h-screen bg-black text-white">
      <div className="max-w-md mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <form onSubmit={onSubmit} className="space-y-4 bg-neutral-900 border border-white/5 p-6 rounded">
          <input className="w-full border border-white/10 bg-neutral-800 text-white rounded px-3 py-2" placeholder="Name" value={name} onChange={(e)=>setName(e.target.value)} required />
